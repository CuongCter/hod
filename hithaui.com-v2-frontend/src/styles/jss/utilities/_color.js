...
export const colorStyles = makeStyles(({ palette }) => ({
  '@global': {
    '.bg-primary': { background: '#F47B2A !important' },
    ...
    '.bg-light-secondary': {
      background: `${(palette.secondary.main, 0.85)} !important`
    },
    '.bg-light-error': {
      background: `${(palette.error.main, 0.85)} !important`
    },
    ...
    '.text-primary': { color: '#F47B2A !important' },
